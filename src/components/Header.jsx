      ...
      <nav className="bg-black text-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to="/" className="flex items-center">
            <img src="./Logoooo.png" className="h-8 mr-3" alt="Flowbite Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white px-2 text-green-500">
              Resolute
            </span>
          </Link>
          <div className="flex md:order-2">
            ...
            <div className="relative hidden md:block">
              ...
              <form
                ...
                className="flex flex-row gap-2 md:mt-2"
              >
                <input
                  type="text"
                  id="search-navbar"
          ...
          >
            ...
            <ul className="flex flex-col p-4 md:font-lg lg:font-semibold md:p-0 mt-4  border text-white rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <NavLink
                  to="/"
